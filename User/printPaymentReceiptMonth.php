<?php
    ...
    //Get payment id from link parameter
    $paymentid_token = htmlentities($_GET["paymentid"]);

    //Get payment detail in user class
    $paymentData = $userObj->readPaymentDetailByMonth($userid, $paymentid_token);
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                  <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: "Source Sans Pro", Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <h1>TMFLIX Payment Receipt ('.$paymentData[2].')</h1>
   ...
   // Load content from html file 
    ...
    // (Optional) Setup the paper size and orientation (landscape, potrait)
